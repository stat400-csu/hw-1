...
Create graphical summaries of the data using what we've learned in class and `ggplot2` and describe your findings. Findings can be written as comments in your code.

Turn in in an electronic copy of your script, **including comments**, to canvas. Your script on rstudio.cloud will also be used in grading, so be sure they are identical.
